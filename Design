...
- Allows gases such as ethylene to pass through
- Provides physical separation between the fruit and biochar
...
The processed material forms the fruit-facing porous layer.
...
→ Size Reduction
→ Sieving
→ Incorporation into the Ethylene-Scavenging Layer
...
At the same time, the banana pseudostem cellulose layer is intended to absorb excess moisture and provide a porous pathway for gas movement.
...
Excess moisture inside fruit packaging can contribute to condensation and may create conditions that promote microbial deterioration.

The banana pseudostem cellulose layer is therefore included not only as a porous layer but also as a moisture-absorbing component.

Its proposed dual function is:

### Moisture Absorption + Porous Gas Pathway

This allows the banana pseudostem layer to contribute to both moisture management and gas movement within the liner.

## 7. Prototype Model

A physical model was prepared to demonstrate the proposed Guava Guard liner structure.

The prototype uses easily available materials to represent the proposed functional layers.
...
The proposed liner should be:

- Low-cost
- Lightweight
- Easy to place inside existing fruit crates
- Made using agricultural-waste-derived materials
- Safe for use around fruits
- Capable of managing excess moisture
- Suitable for gas movement
- Easy to manufacture
- Suitable for storage and transportation

## 9. Future Development

Further experimental testing is required to determine:

- Optimum quantity of rice husk biochar
- Biochar particle size
- Ethylene adsorption capacity
- Suitable banana pseudostem processing method
- Moisture absorption capacity
- Appropriate layer thickness
- Optimum tapioca starch concentration
- Effect of the binder on gas movement
- Effect of the liner on guava shelf life
- Mechanical strength and durability of the final liner
